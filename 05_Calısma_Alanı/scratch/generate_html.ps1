...
if (-not $htmlPath) { Write-Output "CSV_TUM_SONUCLAR.html bulunamadı."; exit }
...
Write-Output "HTML raporu başarıyla nokta formatlı (.dot invariant culture) ve sıfır kaymalı CSV'ler üzerinden tekrar inşa edildi."
