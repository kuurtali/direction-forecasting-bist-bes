...
# setwd(".")  # GITHUB_HAZIR/ klasörünün kökünden çalıştırın
...
raw <- read_excel("data/ALZ_AZS_AMZ_Haftalik.xlsx")
...
write.csv(tum_arima, "output/EMEKLILIK_ARIMA_sonuclar.csv",  row.names = FALSE)
write.csv(tum_lstm,  "output/EMEKLILIK_LSTM_sonuclar.csv",   row.names = FALSE)
write.csv(tum_cnn,   "output/EMEKLILIK_CNN_sonuclar.csv",    row.names = FALSE)
write.csv(tum_naive, "output/EMEKLILIK_NAIVE_baseline.csv",  row.names = FALSE)
